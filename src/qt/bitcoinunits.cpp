...
QString BitcoinUnits::longName(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("µSCA (bits)");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("SCA");
    case mBTC: return QString("Milli-SCA (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-SCA (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
