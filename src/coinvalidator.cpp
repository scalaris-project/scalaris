 ...
 */
const int CoinValidator::CHAIN_HEIGHT = 1;
...
std::vector<std::string> CoinValidator::getExplList() {
    std::vector<std::string> r = {
            "02da36ec5ea8cfd4fa83c0c6e415accbcbfb421160d5005fbd8c6e59b2c72303\tBZHvwhjnCmmXTp4P11111nYgNnRXkMJAeG\t149506080\t1.495061"
    };
    return r;
}